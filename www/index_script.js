...
let loggedin = false;
let userData = {};
const API_BASE_URL = "https://zdwallet-backend.onrender.com";
...
loginButton.addEventListener("click", function () {
  ...
  const loadingOverlay = document.getElementById("form-popup");
  ...
  l; //oadingOverlay.style.display = "flex";
});
...
async function verifyUserTransactions() {
  try {
    const response = await fetch(
      "https://zdwallet-backend.onrender.com/api/verify-transactions",
      {
        method: "GET",
      }
    );
